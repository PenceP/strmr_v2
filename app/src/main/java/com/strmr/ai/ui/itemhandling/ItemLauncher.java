...
import com.strmr.ai.ui.navigation.Destination;
...
public class ItemLauncher {
    ...
    private final Lazy<PreferencesRepository> preferencesRepository = KoinJavaComponent.<PreferencesRepository>inject(com.strmr.ai.preference.PreferencesRepository .class);
