package com.strmr.ai.ui.itemdetail;
...
import com.strmr.ai.constant.CustomMessage;
...
import com.strmr.ai.data.model.InfoItem;
import com.strmr.ai.data.querying.GetAdditionalPartsRequest;
import com.strmr.ai.data.querying.GetSpecialsRequest;
import com.strmr.ai.data.querying.GetTrailersRequest;
import com.strmr.ai.data.repository.CustomMessageRepository;
import com.strmr.ai.data.service.BackgroundService;
import com.strmr.ai.databinding.FragmentFullDetailsBinding;
...
import com.strmr.ai.ui.RecordPopup;
import com.strmr.ai.ui.RecordingIndicatorView;
import com.strmr.ai.ui.TextUnderButton;
import com.strmr.ai.ui.browsing.BrowsingUtils;
...
import com.strmr.ai.ui.playback.PlaybackLauncher;
import com.strmr.ai.ui.presentation.CardPresenter;
import com.strmr.ai.ui.presentation.CustomListRowPresenter;
import com.strmr.ai.ui.presentation.InfoCardPresenter;
import com.strmr.ai.ui.presentation.MutableObjectAdapter;
import com.strmr.ai.ui.presentation.MyDetailsOverviewRowPresenter;
import com.strmr.ai.util.CoroutineUtils;
...
import com.strmr.ai.util.apiclient.BaseItemUtils;
import com.strmr.ai.util.apiclient.Response;
import com.strmr.ai.util.sdk.BaseItemExtensionsKt;
import com.strmr.ai.util.sdk.TrailerUtils;
import com.strmr.ai.util.sdk.compat.JavaCompat;
